...
* 【管脚方向】 Pin direction                                                
********************************************************************************************************/
#define TFT_DATL_OUT()            GPIOSetMultiDir(TFT_DAT_L_PORT, TFT_DAT_L, GPIO_OUT)	 
#define TFT_DATH_OUT()            GPIOSetMultiDir(TFT_DAT_H_PORT, TFT_DAT_H, GPIO_OUT)
	
#define TFT_CS_OUT()              GPIOSetDir(TFT_CS_PORT, TFT_CS_PIN, GPIO_OUT)	
#define TFT_RS_OUT()              GPIOSetDir(TFT_RS_PORT, TFT_RS_PIN, GPIO_OUT)					             
#define TFT_WR_OUT()              GPIOSetDir(TFT_WR_PORT, TFT_WR_PIN, GPIO_OUT)
#define TFT_RD_OUT()              GPIOSetDir(TFT_RD_PORT, TFT_RD_PIN, GPIO_OUT)	
#define TFT_RT_OUT()              GPIOSetDir(TFT_RT_PORT, TFT_RT_PIN, GPIO_OUT)					             
#define TFT_EN_OUT()              GPIOSetDir(TFT_EN_PORT, TFT_EN_PIN, GPIO_OUT)

/********************************************************************************************************
* 【管脚写】 Pin Write                                                
********************************************************************************************************/
#define TFT_DATL_WRITE(dat)       GPIOSetMultiValue(TFT_DAT_L_PORT, TFT_DAT_L, (dat) << TFT_DAT_L_PIN);
#define TFT_DATH_WRITE(dat)    	  GPIOSetMultiValue(TFT_DAT_H_PORT, TFT_DAT_H, (dat) << TFT_DAT_H_PIN); 

#define TFT_CS_WRITE(dat)         GPIOSetValue(TFT_CS_PORT, TFT_CS_PIN, dat)
#define TFT_RS_WRITE(dat)         GPIOSetValue(TFT_RS_PORT, TFT_RS_PIN, dat)
#define TFT_WR_WRITE(dat)         GPIOSetValue(TFT_WR_PORT, TFT_WR_PIN, dat)
#define TFT_RD_WRITE(dat)         GPIOSetValue(TFT_RD_PORT, TFT_RD_PIN, dat)
#define TFT_RT_WRITE(dat)         GPIOSetValue(TFT_RT_PORT, TFT_RT_PIN, dat)
#define TFT_EN_WRITE(dat)         GPIOSetValue(TFT_EN_PORT, TFT_EN_PIN, dat)
