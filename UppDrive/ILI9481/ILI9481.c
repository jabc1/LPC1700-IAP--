...
void TFT_SetGpio(void)
{
	...
	TFT_RT_WRITE(GPIO_SET);
	TFT_WR_WRITE(GPIO_SET);
	TFT_CS_WRITE(GPIO_SET);
	TFT_RS_WRITE(GPIO_SET);
	TFT_RD_WRITE(GPIO_SET);
	TFT_EN_WRITE(GPIO_SET);
...
{
    TFT_RS_WRITE(GPIO_SET);				                              // 写入数据
	TFT_CS_WRITE(GPIO_CLR);

    TFT_DATH_WRITE((u8)(dat>>8));
	TFT_DATL_WRITE((u8)(dat)); 

	TFT_WR_WRITE(GPIO_CLR);
	TFT_WR_WRITE(GPIO_SET);
	TFT_CS_WRITE(GPIO_SET);
}
...
{
    TFT_RS_WRITE(GPIO_CLR);				                                     // 写入指令
	TFT_CS_WRITE(GPIO_CLR);

    TFT_DATH_WRITE((u8)(idx>>8));
	TFT_DATL_WRITE((u8)(idx)); 
